...
The admin dashboard page allows us to manage & look at how our app is doing in an easier way. It can be found at '/dashboard' of the application. 
...
- A goal progress with the amount made thus far from the app. 
...
Refer to the code below for more information
```ts filename="app/(root)/(routes)/dashboard/page.tsx" 
import {
  Calendar,
  CreditCard,
  DollarSign,
