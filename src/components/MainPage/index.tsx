...
export default function MainPage(): JSX.Element {
  return (
    <section className="w-full min-h-[60vh] flex-1 py-24 lg:py-32 overflow-hidden">
      <div className="flex flex-col items-center space-y-10 xl:space-y-16">
        <div className="flex flex-col items-start gap-6 px-10 max-w-6xl">
          <h2 className="m-0">Welcome to the Nizzy Starter Docs!</h2>
          <span className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
            This docs contain a series of guides with examples for libraries and
            tools I use on all my projects. New content will be continuously
            added, so feel free to suggest guides or improvements!
          </span>
        ...
        <div className="max-w-7xl mx-auto w-full flex-grow md:absolute md:top-[45%] md:left-1/2 md:-translate-x-1/2">
